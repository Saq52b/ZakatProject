...
namespace Focus.Persistence.Migrations
{
    ...
    [Migration("20230531075904_benificary_authorization")]
    partial class benificary_authorization
    {
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CashVoucher = false,
                            CompanyRegNo = "56ty60",
                            CreatedDate = new DateTime(2023, 5, 31, 7, 59, 3, 340, DateTimeKind.Utc).AddTicks(4741),
                            DayStart = false,
                            English = false,
