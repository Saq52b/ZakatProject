...
namespace Focus.Persistence.Migrations
{
    ...
    [Migration("20230529123908_benificary_address")]
    partial class benificary_address
    {
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CashVoucher = false,
                            CompanyRegNo = "56ty60",
                            CreatedDate = new DateTime(2023, 5, 29, 12, 39, 7, 182, DateTimeKind.Utc).AddTicks(3880),
                            DayStart = false,
                            English = false,
