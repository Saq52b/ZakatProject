...
namespace Focus.Persistence.Migrations
{
    ...
    [Migration("20230920081936_expensecategoryrelation")]
    partial class expensecategoryrelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Beneficiaries", b =>
                {
                    ...
                    b.Property<DateTime?>("CurrentPaymentMonth")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CashVoucher = false,
                            CompanyRegNo = "56ty60",
                            CreatedDate = new DateTime(2023, 9, 20, 8, 19, 35, 366, DateTimeKind.Utc).AddTicks(3912),
                            DayStart = false,
                            English = false,
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.ExpenseCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Logs", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.SelectedMonth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("SelectMonth")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("Focus.Domain.Entities.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Focus.Business.Users.ApplicationUser", "ApplicationUser")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Focus.Domain.Entities.SelectedMonth", b =>
                {
                    ...
                    b.HasOne("Focus.Domain.Entities.Payment", "Payments")
                        .WithMany("SelectedMonth")
            ...
            modelBuilder.Entity("Focus.Domain.Entities.Beneficiaries", b =>
                {
                    ...
                    b.Navigation("CharityTransactions");
