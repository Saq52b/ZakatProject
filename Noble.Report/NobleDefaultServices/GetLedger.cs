...
namespace Noble.Report.NobleDefaultServices
{
    public static class GetLedger
    {
        ...
        public static PaymentLookupModel GetLedgerDtl(string id, string token,string serverName) {
            ...
            RestRequest request1 = new RestRequest("Benificary/GetCharityTransactionList?Id=" + id );
