...
namespace Noble.Report.NobleDefaultServices
{
    public static class GetFunds
    {
        ...
        public static FundsLookupModel GetFundsDtl (string id,string token,string serverName) {
            ...
            RestRequest request1 = new RestRequest("Benificary/GetFundsDetail?Id=" + id);
          ...
          var GetBenificaryReport = JsonConvert.DeserializeObject<FundsLookupModel>(content1);
